...
- packaged update checks use a fixed DNS TXT record, while installer downloads still point to GitHub Releases
...
- improve packaged-update guidance, including how the DNS TXT record is published and verified, and continue cross-platform follow-up documentation
