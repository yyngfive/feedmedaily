...
The latest released version is `0.4.0`. The next planned release is `0.4.1`, so unreleased product changes should be added under `0.4.1` until that version ships.
